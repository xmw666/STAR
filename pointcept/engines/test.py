...
class TesterBase:
    ...
    def build_model(self):
        ...
        # if True:
            ...
            # checkpoint = torch.load('/mnt/xyz_data_tj/user/xingmingwei001/Pointcept/exp/sonata/sonata_ppt_share_moe_gate_124_841_balance_dynamic0924/model/model_best.pth',weights_only=False)
    ...
    def build_test_loader(self):
        ...
        test_loader = torch.utils.data.DataLoader(
            ...
            shuffle=False,
            num_workers=self.cfg.num_worker_per_gpu, # 修改
            pin_memory=True,
